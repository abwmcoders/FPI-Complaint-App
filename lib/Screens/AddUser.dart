...
import 'package:compliants_system/Screens/login.dart';
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(
                        ...
                        labelText: 'User Name',
                        hintText: 'abc@fpistudent.edu'),
                    validator: (value) {
                      if (!RegExp("^[a-zA-Z0-9+_.-]+@fpi.edu.com")
                          .hasMatch(value!)) {
                        return ("Please Enter a username with @fpi.edu.com at the end");
                      }
                      return null;
                    },
                  ),
